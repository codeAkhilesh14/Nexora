...
export const RoomsPage = () => {
  ...
  if (activeRoom) {
    ...
    return (
      <div className="w-full max-w-2xl mx-auto flex flex-col h-[calc(100vh-172px)] h-[calc(100dvh-172px)] sm:h-[calc(100vh-200px)] pt-0 sm:pt-6 chatting-page-container">
