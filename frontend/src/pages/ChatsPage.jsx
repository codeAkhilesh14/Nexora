...
export const ChatsPage = () => {
  ...
  return (
    <div className="flex flex-col lg:grid h-[calc(100vh-172px)] h-[calc(100dvh-172px)] lg:h-[calc(100vh-200px)] gap-3 sm:gap-4 lg:grid-cols-[280px_minmax(0,1fr)] xl:grid-cols-[330px_minmax(0,1fr)] chatting-page-container">
      <Card tilt={false} className={`max-h-[100%] overflow-hidden p-0 flex-col ${active ? 'hidden lg:flex' : 'flex'}`}>
